...
class App extends Component {
  ...
  state = {
    placesList: [
      { title: "Roundhouse Aquarium", location: {lat: 33.883368, lng: -118.414595}, visible: true },
      { title: "Becker's Bakery & Deli", location: {lat: 33.883937, lng: -118.410461}, visible: true },
      { title: "The Kettle", location: {lat: 33.885366, lng: -118.409663}, visible: true },
      { title: "California Pizza Kitchen", location: {lat: 33.899041, lng: -118.394780}, visible: true },
      { title: "Whole Foods", location: {lat: 33.906682, lng: -118.392783}, visible: true },
      { title: "Ralphs", location: {lat: 33.896281, lng: -118.394272}, visible: true },
      { title: "Pages Book Store", location: {lat: 33.883141, lng: -118.409656}, visible: true },
      { title: "Peet's Coffee & Tea", location: {lat: 33.885273, lng: -118.408892}, visible: true },
      { title: "Martha's 22nd Street Grill", location: {lat: 33.869321, lng: -118.403978}, visible: true },
      { title: "45th Street Beach", location: {lat: 33.904201, lng: -118.422161}, visible: true },
      { title: "Target", location: {lat: 33.888592, lng: -118.394307}, visible: true },
      { title: "Islands Restaurant", location: {lat: 33.899627, lng: -118.394053}, visible: true },
      { title: "El Sombrero", location: {lat: 33.874037, lng: -118.394050}, visible: true },
      { title: "Von's", location: {lat: 33.885148, lng: -118.407879}, visible: true },
      { title: "Barnes and Noble", location: {lat: 33.900630, lng: -118.380849}, visible: true },
      { title: "Mira Costa High School", location: {lat: 33.873556, lng: -118.389907}, visible: true },
      { title: "Manhattan Beach Library", location: {lat: 33.887115, lng: -118.410357}, visible: true }
    ],
    filterQuery: '',
  }
